...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
   ...
   <Link cl to={"/"}><button >Home</button></Link>
   <Link to={"/gov"}><button>Goverment</button></Link>
   <Link to={"/institute"}><button >Institute</button></Link>
   <Link to={"/user"}><button >User</button></Link>
   <Link to={"/verification"}><button >Verification</button></Link>
    </div>
  );
}
